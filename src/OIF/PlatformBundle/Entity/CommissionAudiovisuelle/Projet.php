 ...
 * Projet
 *
 * @ORM\Table(name="oif_commission_audiovisuelle_projet")
 * @ORM\Entity(repositoryClass="OIF\PlatformBundle\Repository\CommissionAudiovisuelle\ProjetRepository")
 */
class Projet{
    /**
     * @var int
    ...
    /**
     * @ORM\OneToMany(targetEntity="OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Fichier", mappedBy="projet", cascade={"remove"})
     */
    protected $fichiers;
    /**
     * @ORM\OneToMany(targetEntity="OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Lien", mappedBy="projet", cascade={"remove"})
     */
    protected $liens;
    /**
     * @ORM\OneToMany(targetEntity="OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Financement", mappedBy="projet", cascade={"remove"})
     */
     ...
     * Add fichier
     *
     * @param \OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Fichier $fichier
     *
     * @return Projet
     */
    public function addFichier(\OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Fichier $fichier)
    {
     ...
     * @param \OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Fichier $fichier
     */
    public function removeFichier(\OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Fichier $fichier)
    {
     ...
     * Add lien
     *
     * @param \OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Lien $lien
     *
     * @return Projet
     */
    public function addLien(\OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Lien $lien)
    {
        $this->liens[] = $lien;
     ...
     * @param \OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Lien $lien
     */
    public function removeLien(\OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Lien $lien)
    {
     ...
     * Add financement
     *
     * @param \OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Financement $financement
     *
     * @return Projet
     */
    public function addFinancement(\OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Financement $financement)
    {
     ...
     * @param \OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Financement $financement
     */
    public function removeFinancement(\OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Financement $financement)
    {
