 ...
 * Lien
 *
 * @ORM\Table(name="oif_commission_audiovisuelle_lien")
 * @ORM\Entity(repositoryClass="OIF\PlatformBundle\Repository\CommissionAudiovisuelle\LienRepository")
 */
class Lien
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="OIF\PlatformBundle\Entity\CommissionAudiovisuelle\Projet", inversedBy="liens")
